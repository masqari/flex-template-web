    ...
    >
      <LayoutSingleColumn>
        ...
        <LayoutWrapperMain className={css.staticPageWrapper}>
          <h1 className={css.pageTitle}>Discover and experience. Here</h1>
          <img className={css.coverImage} src={image} alt="My first ice cream." />

          <div className={css.contentWrapper}>
            <div className={css.contentSide}>
              <p>Did you know that Did you know that Finland has 3.2 million saunas - almost one sauna per person!</p>
            </div>
